...
var cfRoadLine = new cFeature("道路線", "fengchia_roadline.geojson", false, styleRoadLine, ctrlItemRoadLine);
var cfRoadArea = new cFeature("道路輪廓", "fengchia_roadarea.geojson", true, styleRoadArea, ctrlItemRoadArea);
...
var ctrlItemRegion_F = {
                      sID: "id_btn_region_option_f",
                      sCls: "cls_btn_region_options",
                      sCls_Clicked: "cls_btn_region_options_clicked",
                      };

var ctrlItemRegion_S = {
                      sID: "id_btn_region_option_s",
                      sCls: "cls_btn_region_options",
                      sCls_Clicked: "cls_btn_region_options_clicked",
                      };

var ctrlItemRegion_L = {
                      sID: "id_btn_region_option_l",
                      sCls: "cls_btn_region_options",
                      sCls_Clicked: "cls_btn_region_options_clicked",
                    };
...
var vcfRegions = 
[
  new cFeature_Region("Eating", "fengchia_region_F.geojson", false, styleRegion_F, ctrlItemRegion_F),
  new cFeature_Region("Shopping", "fengchia_region_S.geojson", false, styleRegion_S, ctrlItemRegion_S),
  new cFeature_Region("Residential", "fengchia_region_L.geojson", false, styleRegion_L, ctrlItemRegion_L),
];
...
var vcfSpaceSyntax = 
[
  new cFeature_SpaceSyntax("All", "fengchia_roadline.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_All),
  new cFeature_SpaceSyntax("B1", "fengchia_road_B1.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_B1),
  new cFeature_SpaceSyntax("B2", "fengchia_road_B2.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_B2),
  new cFeature_SpaceSyntax("B3", "fengchia_road_B3.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_B3),
  new cFeature_SpaceSyntax("B4", "fengchia_road_B4.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_B4),
  new cFeature_SpaceSyntax("C", "fengchia_road_C.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_C),
  new cFeature_SpaceSyntax("D", "fengchia_road_D.geojson", false, styleSpaceSyntax, ctrlItemSpaceSyntax_D),
];
...
var cfOSMStores = new cFeature_OSMStores("OSM Shop", "xitun.geojson", true, styleOSMStores, ctrlItemOSMStores);
